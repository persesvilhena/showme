...
if($ua == "ftar"){
	$csql = mysqli_query($conecta, "select * from album_ar where id = '$idu';");
$rsql = mysqli_fetch_array($csql);
...
if($ua == "vdus"){
	$csql = mysqli_query($conecta, "select * from videos where id = $idu;");
	$rsql = mysqli_fetch_array($csql);
	echo "
...
$csql = mysqli_query($conecta, "select * from user where id = '$idu';");
$rsql = mysqli_fetch_array($csql);
$conviteartista = mysqli_query($conecta, "select * from artista where id = '$row[idart]';");
$rconviteartista = mysqli_fetch_array($conviteartista);
echo "
...
if($ua == "btn_ar_like"){
	$csql = mysqli_query($conecta, "select * from gostar_ar where id_post = '$idu' and gostei = '1'");
	while($rsql = mysqli_fetch_array($csql)){
		$csqluser = mysqli_query($conecta, "select * from user where id = '$rsql[id_us]'");
		$rsqluser = mysqli_fetch_array($csqluser);
		$datatempo = explode(" ", $rsql['data']);
...
if($ua == "btn_ar_nlike"){
	$csql = mysqli_query($conecta, "select * from gostar_ar where id_post = '$idu' and gostei = '0'");
	while($rsql = mysqli_fetch_array($csql)){
		$csqluser = mysqli_query($conecta, "select * from user where id = '$rsql[id_us]'");
		$rsqluser = mysqli_fetch_array($csqluser);
		$datatempo = explode(" ", $rsql['data']);
...
if($ua == "btn_ar_like2"){
	$csql = mysqli_query($conecta, "select * from gostar_ar where id_repost = '$idu' and gostei = '1'");
	while($rsql = mysqli_fetch_array($csql)){
		$csqluser = mysqli_query($conecta, "select * from user where id = '$rsql[id_us]'");
		$rsqluser = mysqli_fetch_array($csqluser);
		$datatempo = explode(" ", $rsql['data']);
...
if($ua == "btn_ar_nlike2"){
	$csql = mysqli_query($conecta, "select * from gostar_ar where id_repost = '$idu' and gostei = '0'");
	while($rsql = mysqli_fetch_array($csql)){
		$csqluser = mysqli_query($conecta, "select * from user where id = '$rsql[id_us]'");
		$rsqluser = mysqli_fetch_array($csqluser);
		$datatempo = explode(" ", $rsql['data']);
...
if($ua == "mus_edit"){
$csql = mysqli_query($conecta, "select * from musicas where id = '$idu';");
$rsql = mysqli_fetch_array($csql);
...
if($ua == "arft_edit"){
	$qfoto = mysqli_query($conecta, "select * from album_ar where id = '$idu';");
...
if($ua == "ardisc_edit"){
$csql = mysqli_query($conecta, "select * from disc where id = '$idu';");
$rsql = mysqli_fetch_array($csql);
...
if($ua == "ardiscm_edit"){
$csql = mysqli_query($conecta, "select * from disc_musicas where id = '$idu';");
$rsql = mysqli_fetch_array($csql);
...
if($ua == "areven_ver"){
$csql = mysqli_query($conecta, "select * from agenda where id = '$idu';");
$rsql = mysqli_fetch_array($csql);
...
if($ua == "arnoti_ver"){
$csql = mysqli_query($conecta, "select * from noticias where id = '$idu';");
$rsql = mysqli_fetch_array($csql);
$dat = explode("-", $rsql['data']);
