...
if($i1 == null){$i1 = 1;}
if ($i1 == 1){
	$csql = mysql_query("SELECT * FROM musicas WHERE id_us = '$id';");
...
if($i1 == 2){
	$csql = mysql_query("select * from musicas where id = '$i2' and id_us = '$id';");
	...
	if(mysql_num_rows($csql) == 1){
		if(isset($_POST["alterar"])) {
			if(!empty($_POST["nome"]) && !empty($_POST["descricao"])) {
				...
				$altera = mysql_query("update musicas set nome = '$nome', descricao = '$descricao' where id = '$i2' and id_us = '$id';");
				if ($altera){ 
...
if($i1 == 3){
	...
	$rsql = mysql_fetch_array($csql);
	if(mysql_num_rows($csql) == 1){
		$altera = mysql_query("delete from musicas where id = '$i2' and id_us = '$id';");
...
$insert = mysql_query("insert into musicas (id_us, link, nome, descricao) values ('$id', '$nome_final', '$nome', '$descricao');");
if($insert){
