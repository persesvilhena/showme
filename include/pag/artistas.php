...
$res = mysqli_query($conecta, "SELECT * FROM `artista` ORDER BY `artista`.`$ordenado` ASC LIMIT 0, 30 ");
...
<td width=35>UF</td>
  ...
  $csql_estilo = mysqli_query($conecta, "select * from est_musical where id = '$escrever[est_musical]';");
