...
$bcpessoas = mysqli_query($conecta, "select * from user where (nome like '%$procurar%') or (sobrenome like '%$procurar%') order by nome");
$bcartistas = mysqli_query($conecta, "select * from artista where nome like '%$procurar%' order by nome");
...
while($rbcartistas = mysqli_fetch_array($bcartistas)){
	echo "
	<div id=\"item\" style=\"padding: 5px; margin-top: 5px;\">
